...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A emissora premium do universo country, western e agro. Ao vivo, 24 horas." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Fazenda Rodeo TV" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Fazenda Rodeo TV" },
      { name: "twitter:description", content: "A emissora premium do universo country, western e agro." },
    ],
    links: [
